...
export class ImpactAnalyzer {
  analyze(
    ...
    const impactLevel = hasFindings
      ? this.calculateImpact(totalAffected, files)
      : 'low';
  ...
  private collectByRelationship(
    contexts: UnchangedContext[],
    relationship: UnchangedContext['relationship']
  ): CodeSnippet[] {
    return contexts
